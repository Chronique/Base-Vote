...
export default function CreateQuest({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border p-6 rounded-3xl shadow-lg flex flex-col gap-4 transition-all">
      <input value={question} onChange={(e) => setQuestion(e.target.value)} placeholder="What's the question?" className="p-3 bg-gray-50 dark:bg-gray-800 rounded-xl outline-none border border-transparent focus:border-blue-500" />
